...
class SendMailForGetPasswordCustomer {
     ...
     */
    static get type() {
        return 'send-mail-for-get-password-customer';
    }
    ...
    async handle() {
        ...
        await Mail.send('emails.customer_forgot_password', customer, (message) => {
            message
            .to(customer.email)
...
module.exports = SendMailForGetPasswordCustomer;
